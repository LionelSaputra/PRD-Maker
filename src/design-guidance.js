...
export const DESIGN_GUIDANCE_VERSION = '1.1';
export const DESIGN_SKILL_SOURCES = Object.freeze([
  'design-taste-frontend', 'ui-ux-design-pro', 'emil-design-eng', 'impeccable'
]);
...
2. SETIAP MODUL = SATU LAYAR YANG BISA DIBANGUN.
Modul fitur adalah layar atau bagian halaman yang nyata, bukan kategori abstrak. Untuk tiap modul sebutkan: bentuk antarmuka (daftar/tabel, formulir entri, laporan ringkas, pencarian, halaman masuk, bagian naratif), kolom atau field yang tampil (samakan dengan nama kolom di databaseSchema), aksi utama, keadaan kosong, keadaan gagal, dan perilaku mobile. Preview internal merender satu layar per modul dari kolom tabel di PRD ini, jadi deskripsi yang kabur akan menghasilkan layar kabur. Jangan menulis modul yang hanya berupa nama teknologi atau pekerjaan teknis tanpa antarmuka; pekerjaan seperti migrasi, seeding, atau setup deployment ditulis sebagai task, bukan modul.
3. KONKRETKAN SETIAP KEPUTUSAN.
...
4. ANTI-SLOP YANG BISA DIJELASKAN.
...
5. AKSESIBILITAS ADALAH SYARAT, BUKAN CATATAN AKHIR.
...
6. CRAFT TANPA MENGORBANKAN KECEPATAN.
